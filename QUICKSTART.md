...
打开 https://github.com/362507574-sys/DFMH-ZengZhangZhanLueGuan ，选择 `Code → Download ZIP`，解压到类似 `C:\DFMH\DFMH-ZengZhangZhanLueGuan` 的短路径。熟悉 Git 的用户也可以执行：

```powershell
git clone https://github.com/362507574-sys/DFMH-ZengZhangZhanLueGuan.git C:\DFMH\DFMH-ZengZhangZhanLueGuan
```
...
> 请从 https://github.com/362507574-sys/DFMH-ZengZhangZhanLueGuan 更新当前组织包到最新 main 版本，保留仓库外的业务资料，完成后重新运行 npm test 并汇报版本与三个技能。
